...
# copiato da https://github.com/shardlab/discordrb/blob/main/examples/ping.rb

require 'discordrb'

TOKEN = ENV['TOKEN'] or 'NonDatur'

puts "ENV TOKEN: #{TOKEN}"
...
# respective place.
bot = Discordrb::Bot.new token: TOKEN # 'B0T.T0KEN.here'
...
module Ping
  ...
  Bot.command(:memento) do |event|
    event.respond '🤖 Riccardo, I understand you want to remember a MidJourney command you just issued for the future '
    add_command "ciao da me"
